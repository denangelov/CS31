...
int main()
{
    //compile error #1 - forget to use identifiers when initializing variables
    /*
    int numberSurveyed;
    int forNewsom;
    int forCox;
    */
    ...
    //compile error #2 - mix up the alligator brackets for cout and cin
    /*
    ...
    */
    ...
    //compile error #3 - forget to put semicolons
